...
<article id="node-<?php print $node->nid; ?>" class="<?php print $classes; ?> clearfix"<?php print $attributes; ?>>
  ...
  <div class="content"<?php print $content_attributes; ?>>
      ...
      <div class="laminas-obtenidas">
          ...
          <div class="botones">
              <a class="boton-canje-laminas" href="/node/129">Canje Láminas</a>
              <a class="boton-pegar-laminas" href="/node/27?pegar=pegar" id="pegar_laminas">Pegue sus Láminas y Revíselas en su Álbum</a>
          </div>
      </div>
