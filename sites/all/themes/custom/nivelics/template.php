...
/**
 * @file
 * Contains theme override functions and preprocess functions for the Nivelics theme.
 */

/**
 * Changes the default meta content-type tag to the shorter HTML5 version
 */
function nivelics_html_head_alter(&$head_elements) {
 ...
 */
function nivelics_preprocess_search_block_form(&$vars) {
 ...
 */
function nivelics_preprocess_html(&$vars) {
 ...
 $shimset = theme_get_setting('nivelics_shim');
 ...
 */
function nivelics_breadcrumb($vars) {
